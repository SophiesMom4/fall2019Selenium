...
10. Verify that search box is blank
        ...
        public static void main(String[] args) throws InterruptedException {
            ...
            Thread.sleep(2000);
            WebElement countElement = driver.findElement(By.cssSelector("h1>span"));
            ...
            // re initilaze the element that is throwing StaleElementReferenceException
            countElement = driver.findElement(By.cssSelector("h1>span"));
            count = countElement.getText();
            System.out.println(count);
            ...
            if (countOne<countTwo){
                ...
                System.out.println("countO=Two : " +countTwo);
