...
public class VytrackLoginTestWithWait {
    ...
    @BeforeMethod
    public void setUp() {
        driver = WebDriverFactory.getDriver("firefox"); // passes with chrome.. try
    ...
    public void test(){
        ...
        Assert.assertEquals(driver.getTitle(), "Dashboard"); // implicit wait will not help you to get title,
                                                                    // when the page changes the title.
    }
