...
public class ExplicitWaitExamples {
    ...
    //    driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); // if you need to use it..
    ...
    public void test2WaitForVisible(){
        ...
        //waits for given element to be visible on g=page
        ...
        //this will fail. will throw exception.
    } @Test
...
//     give time that is NOT enough. change the wait time
